    ...
    <AppLayout>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="pricing-card-old">
              ...
              <Link href="/contact" className="btn-primary w-full mt-4">Get Location Report</Link>
            </div>
            {/* Basic */}
            <div className="pricing-card-old">
              ...
              <Link href="/contact" className="btn-primary w-full mt-4">Get Basic Report</Link>
            </div>
            {/* Professional */}
            <div className="pricing-card-old">
              ...
              <Link href="/contact" className="btn-primary w-full mt-4">Get Professional Report</Link>
            </div>
            {/* Premium ⭐ */}
            <div className="pricing-card-old popular">
              ...
              <Link href="/contact" className="btn-primary w-full mt-4">Get Premium Report</Link>
            </div>
          </div>
      ...
      <section className="py-20" id="insider" style={{ background: 'linear-gradient(135deg, rgba(201, 162, 39, 0.1) 0%, rgba(30, 58, 95, 0.2) 100%)', borderTop: '1px solid rgba(201,162,39,0.3)', borderBottom: '1px solid rgba(201,162,39,0.3)' }}>
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="#contact" className="btn-primary text-lg px-10 py-4">Become an Insider</Link>
